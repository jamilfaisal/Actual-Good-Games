          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700 hover:border-blue-400 transition duration-300 transform hover:scale-105">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-4">
                  An incredible journey through a fantasy world with deep
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700 hover:border-blue-400 transition duration-300 transform hover:scale-105">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-4">
                  A mind-bending strategy game that will challenge your tactical
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700 hover:border-blue-400 transition duration-300 transform hover:scale-105">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-300 mb-4">
                  Fast-paced action combined with exploration and puzzle-solving
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Every game is carefully selected and reviewed to ensure quality
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Detailed, unbiased reviews covering gameplay, graphics, story,
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Rate games yourself and see what the community thinks about each
                title.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-gray-400">
              © 2025 Actual Good Games. Built for gamers, by gamers.
            </p>
          </div>
        </div>
      </footer>
